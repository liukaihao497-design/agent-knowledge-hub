...
import com.lkh.domain.agent.model.valobj.AiClientToolMcpVO;
...
public class AiClientToolMcpNode extends AbstractArmorySupport {
    ...
    protected String doApply(ArmoryCommandEntity requestParameter, DefaultArmoryStrategyFactory.DynamicContext dynamicContext) throws Exception {
        ...
        for (AiClientToolMcpVO mcpVO : aiClientToolMcpList) {
            ...
            try{
                mcpSyncClient = createMcpSyncClient(mcpVO);
            }
            catch (Exception e){
                log.error("mcp client配置失败,{}",mcpVO.getMcpId());
                throw e;
            }
    ...
    private McpSyncClient createMcpSyncClient(AiClientToolMcpVO aiClientToolMcpVO) {
        ...
        switch (transportType) {
            case "sse" -> {
                ...
                // http://127.0.0.1:9999/sse?apikey=REPLACE_WITH_TOKEN
