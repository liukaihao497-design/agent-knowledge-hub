package com.lkh.domain.agent.service.execute.auto.step;


import cn.bugstack.wrench.design.framework.tree.StrategyHandler;
import com.lkh.domain.agent.model.entity.AutoAgentExecuteResultEntity;
import com.lkh.domain.agent.model.entity.ExecuteCommandEntity;
import com.lkh.domain.agent.model.valobj.AiAgentClientFlowConfigVO;
import com.lkh.domain.agent.model.valobj.enums.AiClientTypeEnumVO;
import com.lkh.domain.agent.service.execute.auto.step.factory.DefaultAutoAgentExecuteStrategyFactory;
...
public class Step3QualitySupervisorNode extends AbstractExecuteSupport {
    ...
    protected String doApply(ExecuteCommandEntity requestParameter, DefaultAutoAgentExecuteStrategyFactory.DynamicContext dynamicContext) throws Exception {
        ...
        log.info("任务执行3:{}", supervisionResult);
